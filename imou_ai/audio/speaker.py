...
# File nay nam trong imou_ai/audio/, con config.json/assets/imou-life
# nam o thu muc goc du an (3 cap tren: audio -> imou_ai -> goc).
...
sound = os.path.join(
    BASE,
    cfg["alert"].get("sound", "assets/sound.wav")
)
